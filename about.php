        ...
        <div class="row g-5 align-items-center">
                ...
                <div class="timeline">
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            <p>Chef Marco and Sophia opened a small 20-seat bistro with a simple mission: serve
                                authentic flavors with love.</p>
                        </div>
                    </div>
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            <p>Moved to our current location with 80 seats and received our first culinary award for
                                "Best New Restaurant".</p>
                        </div>
                    </div>
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            <p>Established direct relationships with local farms to ensure the freshest ingredients for
                                our dishes.</p>
                        </div>
                    </div>
                    <div class="timeline-item">
            ...
            <div class="col-lg-6">
                <div class="ratio ratio-16x9 rounded-3 overflow-hidden shadow">
                    <img src="images/about us 1.jpg" alt="FoodCorner through the years" class="img-fluid"
                        style="object-fit: cover;">
                </div>
                <div class="mt-4 p-4 bg-light rounded-3">
                    <h4 class="fw-bold mb-3">Our Philosophy</h4>
                    <p class="mb-0">"We believe great food starts with respect - for ingredients, for tradition, and for
                        the people we serve. Every dish tells a story of craftsmanship and care."</p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 overflow-hidden team-card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted">With 25 years of experience, Chef Marco brings Indian and international
                            flavors to your plate.</p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 overflow-hidden team-card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted">Trained in French techniques, Anika adds her Indian touch to every dish.
                        </p>
                        <div class="social-links mt-3">
                            <a href="#" class="text-dark mx-2"><i class="fab fa-instagram"></i></a>
                            <a href="#" class="text-dark mx-2"><i class="fab fa-twitter"></i></a>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card border-0 bg-light h-100">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted">We source 85% of ingredients locally and minimize food waste through
                            careful planning.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <p class="fst-italic mb-4">"The chicken tikka masala was the best I've had outside of India.
                            Perfectly spiced and incredibly flavorful."</p>
                        <div class="d-flex align-items-center">
                            <img src="images/testimonial1.jpg" class="rounded-circle me-3" width="50" height="50"
                                alt="Guest">
                            <div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <p class="fst-italic mb-4">"Our anniversary dinner was magical. The service was impeccable and
                            the grilled chicken platter was divine."</p>
                        <div class="d-flex align-items-center">
                            <img src="images/testimonial2.jpg" class="rounded-circle me-3" width="50" height="50"
                                alt="Guest">
                            <div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <p class="fst-italic mb-4">"As a chef myself, I appreciate the technique and quality at
                            FoodCorner. The crispy fried chicken is a must-try!"</p>
                        <div class="d-flex align-items-center">
                            <img src="images/testimonial3.jpg" class="rounded-circle me-3" width="50" height="50"
                                alt="Guest">
                            <div>
            ...
            <div class="col-lg-6">
                ...
                <div class="mb-4">
                    ...
                    <p><strong>Phone:</strong> +91 98765 43210<br>
                        <strong>Email:</strong> hello@foodcorner.com
                    </p>
                </div>
